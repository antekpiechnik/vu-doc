...
evolved, users started to use `tweets` for a variety of purposes, such as conversations, sharing information/URLs and reporting news(\cite{why-we-twitter} , \cite{twitter-content-is-it}). In order to use such unstructured data for extracting information about user activities related to the media, certain approaches need to be undertaken. In this section we describe available methods to achieve this as well as measurements
