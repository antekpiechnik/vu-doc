...
\textit{YouTube}, whereas the following section covers possible methods of
extracting preference information from \textit{Twitter} users' timelines. This
data has been analyzed with regards to extracting NEs from both sources, as this
is the primary method for user profile generation, that we used. The NEs we used 
are primarily media-related and come from the freebase dataset, and described
in the previous section.

\subsection{YouTube}

YouTube stores various pieces of data concerning its users and content, and offers a public
