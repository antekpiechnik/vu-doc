...
describing their relation to the topic (such as show names actors starred in). This has greatly improved our results, but they may now contain more noise:
...
In order to measure the certainty, a separate function has been introduce, taking into account the following:
