...
\begin{figure}
\includegraphics[width=12cm]{images/favs.png} \\
\caption{Histogram of favourites function usage. Over the x axis there a groups
of users having between $x_1$ and $x_2$ favourites. The height indicates the
size of a group.}
\end{figure}

\begin{figure}
\includegraphics[width=12cm]{images/subs.png} \\
\caption{Histogram of subscriptions function usage. Users are divided into
groups based on number of their subscriptions. We can see that almost 5000 out
of 7500 users subscribe to less than 50 channels.}
\end{figure}

\begin{figure}
\includegraphics[width=12cm]{images/ups.png} \\
\caption{Histogram of upload function usage. Almost 6000 out of 7500 users
uploaded less than 40 clips.}
\end{figure}
