...
The results described in this subsection are very promising. They suggest that similar methods could
be successfully applied to removing false positives from \textit{YouTube} data (\eg titles and descriptions).
