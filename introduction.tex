...
We decided to focus on \textit{Twitter} and \textit{YouTube} due to time constraints and diversification of those two
services.
...
\textit{NoTube} project. It will also enable us to easily evaluate our results by users profiled.
