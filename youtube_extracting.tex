...
\begin{figure}[h!]
  \begin{center}
    ...
    \end{tabular}
    \caption{Results of the text-search based identification of actors within user's favorites}
  \end{center}
\end{figure}

This approach is not ideal. Many false positives can be returned, particularily
for concepts that are also common phrases (e.g. the "Lost" TV show).
